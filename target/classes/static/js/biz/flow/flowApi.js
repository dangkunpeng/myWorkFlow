    ...
    layui.use('table', function () {
        ...
        tableIns = table.render({
            ...
            cols: [[
                ...
                fun.formatField("stepId", stepMap);
            }
        });
...
function formSubmit(obj) {
    $ajaxPost("/flowApi/start", $("#editForm").formData());
}
...
function next(obj) {
    layer.confirm(fun.confirmMsg, fun.confirmBtns, function () {
        $ajaxPost("/flowApi/vote", {"bizId": obj.bizId, "result": "Approve"});
    }, function () {
        layer.closeAll();
    });
}
...
function forceNext(obj) {
    layer.confirm(fun.confirmMsg, fun.confirmBtns, function () {
        $ajaxPost("/flowApi/forceNext", {"bizId": obj.bizId});
    }, function () {
        layer.closeAll();
    });
}
...
function forceTerminate(obj) {
    ...
    layer.confirm(fun.confirmMsg, fun.confirmBtns, function () {
        $ajaxPost("/flowApi/forceTerminate", {"bizId": obj.bizId});
    }, function () {
        layer.closeAll();
    });
}
    ...
    layui.use('table', function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                fun.formatField("lineId", lineMap);
                fun.formatField("stepId", stepMap);
                fun.formatField("userIdTo", userMap);
                fun.formatField("userIdFrom", userMap);
