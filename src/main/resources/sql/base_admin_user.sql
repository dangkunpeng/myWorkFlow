...
-- ----------------------------
INSERT INTO `base_admin_user` (`id`, `sys_user_name`, `sys_user_pwd`, `role_id`, `user_phone`, `reg_time`, `user_status`) VALUES (1, 'admin', 'b7a62a43072fd7f56cd70b5674456a13', 1, '18698683698', '2018-11-22 10:57:33', 1);
INSERT INTO `base_admin_user` (`id`, `sys_user_name`, `sys_user_pwd`, `role_id`, `user_phone`, `reg_time`, `user_status`) VALUES (2, 'jackson', '6565673a6caee66a6acbd51415bddbda', 2, '19563648695', '2018-11-22 10:57:33', 1);
INSERT INTO `base_admin_user` (`id`, `sys_user_name`, `sys_user_pwd`, `role_id`, `user_phone`, `reg_time`, `user_status`) VALUES (4, 'alice', '5e1030d25f5ca46aac4c0369b908d762', 2, '11111111111', '2018-11-22 11:01:58', 1);
