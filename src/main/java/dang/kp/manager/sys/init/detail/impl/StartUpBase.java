...
public class StartUpBase implements StartUpService {
    ...
    public ResultData run() {
        ...
        BaseSource srcK12 = StartUpUtils.getSource(5, MyConstants.ROOT_SOURCE_ID, "K12管理", "");
        sourceList.add(srcSys);
        sourceList.add(srcBase);
        sourceList.add(srcFlowInit);
        sourceList.add(srcFlowQuery);
        sourceList.add(srcK12);
        ...
        sourceList.add(StartUpUtils.getSource(1, srcK12.getSourceId(), "K12课程管理", "/k12Class/init"));
        sourceList.add(StartUpUtils.getSource(2, srcK12.getSourceId(), "K12学生管理", "/k12Student/init"));
        sourceList.add(StartUpUtils.getSource(3, srcK12.getSourceId(), "K12学生课程", "/k12Log/init"));
